...
export function IconMenu({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className}>
      <path
        d="M6 3v6a2.5 2.5 0 0 0 5 0V3M8.5 9v12M18 3c-2 1.5-2 4-2 6s2 2 2 2v9"
        strokeLinecap="round"
...
export function IconLogout({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className}>
      <path
        d="M9 21H5.5A1.5 1.5 0 0 1 4 19.5v-15A1.5 1.5 0 0 1 5.5 3H9M16 16l4-4-4-4M20 12H9"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function IconUsers({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className}>
      ...
      <path d="M16 5.5a3 3 0 0 1 0 5.9M19 19c0-2.5-1.7-4.4-4-5" strokeLinecap="round" />
    </svg>
  );
}
